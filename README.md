 ...
 **Mới cài Ubuntu?** → Đọc [: Cài đặt ROS 2 Lyrical](./ros2-lyrical-install-guide.md) trước
 **Đã cài xong ROS 2?** → Đọc [: Môi trường phát triển](./README-ROS2-Dev-Environment.md) để bắt tay vào code
